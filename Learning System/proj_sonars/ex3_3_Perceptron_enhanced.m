...
for Cross_Validation_Mum = 1:10
    ...
    % Perceptron 1
    net_comp_1 = newff(TrainSet',TrainOutput');
...
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 2
    net_comp_2 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 3
    net_comp_3 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 4
    net_comp_4 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 5
    net_comp_5 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 6
    net_comp_6 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 7
    net_comp_7 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 1
    net_comp_8 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 9
    net_comp_9 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    % Perceptron 10
    net_comp_10 = newff(TrainSet',TrainOutput');
%     net.divideFcn = 'divideind';
%     net.divideParam.trainInd = TrainSetInd;
%     net.divideParam.valInd = ValSetInd;
    ...
    clear ValOutput TrainSet TrainOutput ValSet Perceptron_Classifier_Result Perceptron_Classifier_Output net_comp_1 net_comp_2 net_comp_3 net_comp_4 net_comp_5 net_comp_6 net_comp_7 net_comp_8 net_comp_9 net_comp_10
end
