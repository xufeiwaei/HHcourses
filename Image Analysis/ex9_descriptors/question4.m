...
zs=zeros(round(3*size(img2))); %create a larger image 
zs(50:(size(img2,1)+49),50:(size(img2,2)+49))=img2; %Translate the E character with ?x=15 and ?y=32 
img3=zs;
[SRTe]=FD_contour(img3,5); %compute ref vector and contour points, and display
