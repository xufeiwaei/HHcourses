...
public class AnswerQuestion extends Activity{
    ...
    public static final String SEND_ACTION = "com.example.se.hh.sungao.lab4.SEND";
    char ChoiceNumber;
    ...
    for(;clientString.charAt(i)!='"';i++)
    {
    	c3+=clientString.charAt(i);
    }
    
	QuestionText.setText(question);//@@sungao display question
	choice1.setText(c1);
	choice2.setText(c2);
	choice3.setText(c3);
	...
	submit.setOnClickListener(new OnClickListener() {
		public void onClick(View v) {
			if(ChoiceNumber != 0)
			{
				...
				Toast.makeText(AnswerQuestion.this, "Submitted!", Toast.LENGTH_SHORT).show();
				finish();
			}
			else
			{
				Toast.makeText(AnswerQuestion.this, "Answer can't be empty!", Toast.LENGTH_SHORT).show();
			}
		}
	    });
