...
Ix    = zeros(size(imNew),'single'); %"L1", this line should NOT be zeros 
Iy    = zeros(size(imNew),'single'); %"L2", this line should NOT be zeros
...
%%%derivative
It    = zeros(size(imNew),'single'); %"L3", this line should NOT be zeros
